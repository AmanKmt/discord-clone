    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
                ...
                {isAdmin && (
                    <DropdownMenuItem onClick={() => onOpen("deleteServer", { server })} className="text-red-500 dark:text-rose-500 px-3 py-2 text-sm cursor-pointer">
                        Delete Server
                ...
                {!isAdmin && (
                    <DropdownMenuItem onClick={() => onOpen("leaveServer", { server })} className="text-red-500 dark:text-rose-500 px-3 py-2 text-sm cursor-pointer">
                        Leave Server
